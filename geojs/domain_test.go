...
// HTTP behaviour is covered in geojs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "geojs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("geojs", "about")
	if err != nil || got.String() != "geojs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want geojs://page/about", got.String(), err)
	}
}
