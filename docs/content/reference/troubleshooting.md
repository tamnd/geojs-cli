...
Most of these come down to network reality or how geojs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

geojs rate-limits like any public site. geojs already paces
...
Where a surface is gated, geojs reads a cookie or token you supply
...
`geojs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what geojs actually did
